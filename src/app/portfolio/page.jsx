    ...
    >
          ...
          <motion.div style={{ x }} className="flex">
            ...
            {items.map((item) => (
              <div
                ...
                key={item.id}
              >
                <div className="flex flex-col gap-8 text-white py-16">
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        ...
        <div className="relative">
          ...
          <Link
            href="/"
            className="h-16 w-16 md:h-28 md:w-28 flex items-center justify-center absolute top-0 left-0 right-0 bottom-0 m-auto bg-black text-white rounded-full"
          >
            Hire Me
          </Link>
        </div>
